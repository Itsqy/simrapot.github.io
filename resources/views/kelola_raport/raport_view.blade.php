...
<body>
    <div class="row d-flex justify-content-between">
        <div class="col-lg-2">
            <img src="{{ asset('icon/idn.png') }}" class="w-50 logo_wk">
        </div>
        <div class="col-lg-10 text-right header-raport">
            ...
            <p>Jl. Raya Dayeuh, Sukanegara, Kec. Jonggol, Bogor, Jawa Barat 16830 Jonggol, West Java 16830</p>
            <p>Website : idn.sch.id, e-mail : No. Telp : SMK-Jonggol wa.me/6282210102004</p>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var catatan = "{{ $catatan }}";
        if (catatan == "") {
            $('#siswa-catatan').text('Tidak Ada');
        } else {
            $('#siswa-catatan').text(catatan);
        }
