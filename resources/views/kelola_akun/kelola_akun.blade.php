...
@section('isi')
    <div class="container-fluid" id="kelola_akun_1">
        <div class="row">
            <div class="col-md-12 " id="title-menu">
                <div class="card-header">
                    <div class="">
                        <h4 class="mt-1" style="color: #3e3d3e; font-weight: bold;">Kelola Akun</h4>


                        <div class="d-flex justify-content-between"> <button class=" btn btn-primary btn-round "
                                style="margin-left: 830px" data-bs-toggle="modal" data-bs-target="#importModal"><i
                                    class="fas fa fa-plus fa-sm text-white-50"></i>
                                IMPORT DATA</button>
                            <button class=" btn btn-primary btn-round ms-auto" data-bs-toggle="modal"
                                data-bs-target="#saveModal"><i class="fas fa fa-plus fa-sm text-white-50"></i>
                                Tambah
                                Data</button>
                        </div>
                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if ($u->role == 'Guru')
                                                                ...
                                                                <button id="{{ $u->kd_guru }}"
                                                                    class="btn hapusakun btn-icon-split"
                                                            ...
                                                            @else
                                                                ...
                                                                <button id="{{ $u->kd_guru }}"
                                                                    class="btn hapus-kurikulum btn-icon-split"
                                                                    style="background-color: #5700e2; color: #fff;">
                                                                    <span class="icon text-white-50">
                                                                        <i class="fas fa-trash"></i>
                                                                    </span>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12 mb-2" align="center">
                                    <img src="{{ asset('intruksi_gambar/importuser.png') }}" class="img-fluid w-100">
                                    <h5 class="mt-3 mb-1" style="color: #7a00e2;">Import User</h5>


                                </div>
                                <p>Pastikan format dan penempatan sesuai dengan gambar diatas dan sebagai berikut :</p>
                                <ul>
                                    <li>Kosongkan Baris ID </li>
                                    <li>Isilah kolom IMAGE dengan user.png </li>
                                    <li>isilah KD_GURU secara urutan dan sesuai kode guru terakhir yang ada di halaman
                                        kelola akun </li>

                                    <li>Isilah ROLE dengan diawali dengan uruf kapital , dan ROLE hanya terdiri dari 2 ROLE
                                        yaitu : Kurikulum , Guru</li>
                                    <li>Isilah MAPEL dengan kode mapel yang ada di tabel berikut :</li>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <form method="POST" action="{{ url('/import_user') }}" enctype="multipart/form-data">
                                        @csrf
            ...
            <div class="modal fade" id="tambahMapelModal" tabindex="-1" role="dialog"
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <form id="tambahMapel" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="mapel" type="text" class="form-control" id="namaMapel"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <button type="submit" class="btn btn-block"
                                                    style="color: #fff; background-color: #b854f5;">Tambah Mapel</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <form method="POST" id="formSave">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12" id="maksKode">
                                        <input type="text" class="form-control" name="kd_guru" readonly=""
                                            value="{{ $max4 }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row mapel_select">
                                    ...
                                    <div class="col-sm-2 tambah-mapel-btn">
                                        <button class="btn btn-block" data-bs-dismiss="modal" data-bs-toggle="modal"
                                            data-bs-target="#tambahMapelModal"
                                            style="color: #fff; background-color: #b854f5;"><i
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-block"
                                        style="background-color: #b854f5; color: #fff; border-radius: 5px;">Simpan</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <div class="container-fluid" id="">
        <div class="row">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST" id="formEdit">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="custom-file">
                                            <input type="file" name="avatarupdate" class="custom-file-input"
                                                id="avatarupdate">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" placeholder="Nama" class="form-control" name="nameupdate"
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-block"
                                        style="background-color: #b854f5; color: #fff; border-radius: 5px;"
            ...
            <div class="modal fade" id="tamabahKelas" tabindex="-1" role="dialog" aria-labelledby="tamabahKelasLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form method="POST" id="formTambahKelas">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <select multiple="multiple" style="width: 100%;" id="select1"
                                            class="form-control" name="kd_rombel[]" required="">
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-block"
                                        style="background-color: #b854f5; color: #fff; border-radius: 5px;">Tambah</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb shadow" style="background-color: #fff;">
                        <li class="breadcrumb-item"><a href="{{ url('/kelola_akun') }}" class="backkelola">Kelola
                                Akun</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="form-group row text-white">
                                <div class="col-sm-12">
                                    <input type="text" class="form-control-plaintext" style="color: #7a00e2;" readonly=""
                                        id="editrole">
                                    <hr style="border-color: #7a00e2; margin-top: -5px; margin-bottom: -10px;">
                                </div>
                            </div>
                            <div class="form-group row text-white">
                                <div class="col-sm-12">
                                    <input type="text" class="form-control-plaintext" style="color: #7a00e2;" readonly=""
                                        id="editmapel">
                                    <hr style="border-color: #7a00e2; margin-top: -5px;" id="hrmapel">
                                </div>
                            </div>
                        </form>
                        <div class="text-center">
                            <a href="#" data-bs-toggle="modal" id="editBtn" class="btn"
                                data-bs-target="#editModal"
                                style="background-color: #b854f5; color: #fff; font-size: 14px; font-weight: bold; border-radius: 50px;">Edit
                                Data</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                            <a class="dropdown-bs-toggle" href="#" role="button" data-bs-target="#tamabahKelas"
                                data-bs-toggle="modal" id="tamabahKelasBtn">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-group">
                                    {{-- <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">Kelas I</h5>
                                            <ul class="list-group" id="kelas-i">

                                            </ul>
                                            <h5 class="card-title">Kelas II</h5>
                                            <ul class="list-group" id="kelas-ii">

                                            </ul>
                                            <h5 class="card-title">Kelas III</h5>
                                            <ul class="list-group" id="kelas-iii">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">Kelas IV</h5>
                                            <ul class="list-group" id="kelas-iv">

                                            </ul>
                                            <h5 class="card-title">Kelas V</h5>
                                            <ul class="list-group" id="kelas-v">

                                            </ul>
                                            <h5 class="card-title">Kelas VI</h5>
                                            <ul class="list-group" id="kelas-vi">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <ul class="list-group" id="kelas-vii">

                                            </ul>
                                            <h5 class="card-title">Kelas VIII</h5>
                                            <ul class="list-group" id="kelas-viii">

                                            </ul>
                                            <h5 class="card-title">Kelas IX</h5>
                                            <ul class="list-group" id="kelas-ix">
    ...
    <script type="text/javascript">
                    ...
                    if (response != "") {
                        ...
                        for (var i = 0; i < response.tingkat1.length; i++) {
                            kelas_x = kelas_x +
                                ...
                                response.tingkat1[i].rombel + '<a href="#" id="' + response.tingkat1[i]
                                .id +
                                '" class="hapuskelas"><span class="badge badge-primary badge-pill">x</span></a></li>';
                        }
                        for (var i = 0; i < response.tingkat2.length; i++) {
                            kelas_xi = kelas_xi +
                                '<li class="list-group-item d-flex justify-content-between align-items-center">' +
                                response.tingkat2[i].rombel + '<a href="#" id="' + response.tingkat2[i]
                                .id +
                                '" class="hapuskelas"><span class="badge badge-primary badge-pill">x</span></a></li>';
                        }
                        for (var i = 0; i < response.tingkat3.length; i++) {
                            kelas_xii = kelas_xii +
                                '<li class="list-group-item d-flex justify-content-between align-items-center">' +
                                response.tingkat3[i].rombel + '<a href="#" id="' + response.tingkat3[i]
                                .id +
                                '" class="hapuskelas"><span class="badge badge-primary badge-pill">x</span></a></li>';
                        }
                        // for (var i = 0; i < response.tingkat4.length; i++) {
                        //     kelas_xii = kelas_xii +
                        //         '<li class="list-group-item d-flex justify-content-between align-items-center">' +
                        //         response.tingkat4[i].rombel + '<a href="#" id="' + response.tingkat4[i]
                        //         .id +
                        //         '" class="hapuskelas"><span class="badge badge-primary badge-pill">x</span></a></li>';
                        // }
                        // for (var i = 0; i < response.tingkat5.length; i++) {
                        //     kelas_xii = kelas_xii +
                        //         '<li class="list-group-item d-flex justify-content-between align-items-center">' +
                        //         response.tingkat5[i].rombel + '<a href="#" id="' + response.tingkat5[i]
                        //         .id +
                        //         '" class="hapuskelas"><span class="badge badge-primary badge-pill">x</span></a></li>';
                        // }
                        // for (var i = 0; i < response.tingkat6.length; i++) {
                        //     kelas_xii = kelas_xii +
                        //         '<li class="list-group-item d-flex justify-content-between align-items-center">' +
                        //         response.tingkat6[i].rombel + '<a href="#" id="' + response.tingkat6[i]
                        //         .id +
                        //         '" class="hapuskelas"><span class="badge badge-primary badge-pill">x</span></a></li>';
                        // }
                        ...
                        for (var i = 0; i < response.rombel.length; i++) {
                            rombel = rombel + '<option id="rombel_id" value="' + response.rombel[i]
                                .kd_rombel + '">' + response.rombel[i].rombel + '</option>';
                        }
                        for (var i = 0; i < response.rombel_ajar.length; i++) {
                            rombel = rombel + '<option id="rombel_id" value="' + response.rombel_ajar[i]
                                .kd_rombel + '">' + response.rombel_ajar[i].rombel + '</option>';
                        }
        ...
        $('#formSave').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    var warning =
                        '<div class="alert" role="alert" style="background-color: #d7b2f6; color: #7a00e2;">Username telah digunakan</div>';
                    if (data == "sukses") {
                ...
                success: function(response) {
                    if (response.status == "sukses") {
                        if (response.user.avatar == null) {
                            ...
                            $('#fotouser').attr('src', "{{ asset('picture') }}/" + response.user
                                .avatar);
                        }
