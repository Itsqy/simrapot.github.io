...
Route::group(['middleware' => ['auth', 'checkRole:Kurikulum']], function () {
    ...
    Route::get('/kelola_akun/kd_mapel', 'KelolaAkunController@get_mapel');
    ...
    Route::post('/import_user', 'KelolaAkunController@import_user');
    //------------------------------------------------------------
    // 					Kelola Kelas Ajar
    //------------------------------------------------------------
    ...
    //--
    // ----------------------------------------------------------
    // make a route for public function search_siswa
    // ----------------------------------------------------------
    // make a route for public function search_siswa
    Route::get('/search_siswa', 'KelolaSiswaController@search_siswa')->name('search');
    ...
    Route::get('/data_siswa', 'KelolaRaportController@data_siswa');
    Route::get('/data_siswa/{nis}', 'KelolaRaportController@detail_siswa');
    Route::get('/kelola_raport/cetak_raport/{ulangan}/{nis}', 'KelolaRaportController@cetak_raport');
    Route::get('/kelola_raport/raport_view/{nis}/{ulangan}/{senbud}/{upd}/{pramuka}/{sikap}/{catatan}', 'KelolaRaportController@raport_view');
    //------------------------------------------------------------
    // 					    Tahun Ajar
    //------------------------------------------------------------
